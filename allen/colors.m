...
%
% Make sure you loaded data generated by the compare program.
...
% ex is expressing
ex = b(rndIDX(1:len2), :);
% Split into blue channel (with additional 1s for regression) and redgreen:
blue = [ex(:,1), ones(length(ex), 1)];
redgreen = ex(:,2:3);
