    ...
    with h5py.File(filename, 'r') as f:
        ...
        for j in range(0,nboxes): # or 0,nboxes
            ...
            if do_dplots:
                ...
                axs.plot(box_depth, box_signal, color=sc.gray70, markersize=2, marker='.', linestyle='none')
            ...
            if do_dplots:
                axs.plot(bedges[1:], mean_signal, color=sc.deepskyblue2, linewidth=2, marker='None', linestyle='-')
