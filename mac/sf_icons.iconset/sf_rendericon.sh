...
for i in 16 32 128 256 512; do
    convert sf_rendericon.png -resize ${i}x${i} icon_${i}x${i}.png
done

convert sf_rendericon.png -resize 32x32 icon_16x16@2x.png
convert sf_rendericon.png -resize 64x64 icon_32x32@2x.png
